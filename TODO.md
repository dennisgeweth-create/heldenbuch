...
- ~~Die zehn Wünsche vom Spielabend im September 2026~~ — Merkmale ohne
  Ziel, Zustände im Zugfenster und der Laden mit zwei Reitern in **v5.5**;
  Rückgängig, Zustände aus Zaubern, Merkmale mit Zauber und Ressource,
  laufende Wirkungen, Gegenstandswerte und die Post an die Spielleitung
  in **v5.6**.
