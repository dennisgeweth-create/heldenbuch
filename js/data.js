...
// Bogen ändert.
//
// `mc` sind die Voraussetzungen fürs Mischen: eine Liste von
// Möglichkeiten, jede eine Liste von Attributen, die auf 13 stehen
// müssen. Der Kämpfer nimmt Stärke **oder** Geschicklichkeit, der
...
const KLASSEN_REGELN = {
  Barbar:       {tw:12, mc:[['str']],  zauber:null,   asi:[4,8,12,16,19],          unter:3, rw:['str','con'],
  ...
  Barde:        {tw:8,  mc:[['cha']],  zauber:'voll', asi:[4,8,12,16,19],          unter:3, rw:['dex','cha'],
  ...
  Kleriker:     {tw:8,  mc:[['wis']],  zauber:'voll', asi:[4,8,12,16,19],          unter:1, rw:['wis','cha'],
  ...
  Druide:       {tw:8,  mc:[['wis']],  zauber:'voll', asi:[4,8,12,16,19],          unter:2, rw:['int','wis'],
  ...
  'Kämpfer':    {tw:10, mc:[['str'],['dex']],  zauber:null,   asi:[4,6,8,12,14,16,19],     unter:3, rw:['str','con'],
  ...
  'Mönch':      {tw:8,  mc:[['dex','wis']],  zauber:null,   asi:[4,8,12,16,19],          unter:3, rw:['str','dex'],
  ...
  Paladin:      {tw:10, mc:[['str','cha']],  zauber:'halb', asi:[4,8,12,16,19],          unter:3, rw:['wis','cha'],
  ...
  'Waldläufer': {tw:10, mc:[['dex','wis']],  zauber:'halb', asi:[4,8,12,16,19],          unter:3, rw:['str','dex'],
  ...
  Schurke:      {tw:8,  mc:[['dex']],  zauber:null,   asi:[4,8,10,12,16,19],       unter:3, rw:['dex','int'],
  ...
  Zauberer:     {tw:6,  mc:[['cha']],  zauber:'voll', asi:[4,8,12,16,19],          unter:1, rw:['con','cha'],
  ...
  Hexenmeister: {tw:8,  mc:[['cha']],  zauber:'pakt', asi:[4,8,12,16,19],          unter:1, rw:['wis','cha'],
