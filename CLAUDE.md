...
| `bilder/` | Bilder der Automaten (`bilder/hut/`, `bilder/buch/`, `bilder/arena/`, `bilder/auge/` je 160 px JPEG; `bilder/glueck/`: Dreifaches Glück, freigestellt als PNG) — der Deploy kopiert den ganzen Ordner |
...
| ↳ `planer/src/*.jsx` | Quellen des Planers — hier wird bearbeitet. Reine Rechnung: `1-paket.jsx` (ZIP und `.hbplan`), `1b-kacheln.jsx` (Kachelpyramide, Ansicht, Maßstab), `1c-reise.jsx` (Gelände, Reisetage, Gewaltmarsch, Wetter, Aufträge), `1d-begegnung.jsx` (Regionen, Wachen, Begegnungswurf, Reisetagebuch), `1e-sicht.jsx` (Nebel, Spielersicht, Handouts), `1f-welt.jsx` (Figuren und Zeit, Dateiverweise, Quests, Wissen, Fraktionen, Proviant, Navigation, Hexfelder, Offline), `1g-gruppe.jsx` (Heldengruppen: Spur, Sicht, Teilen, Vereinen). Dazu `2-leinwand.jsx` (Kartenansicht), `3-ort.jsx` (Bilder schneiden, Ortstafel), `3b-reise.jsx` (Route- und Reisetafel), `3c-begegnung.jsx` (Regionstafel, Tabelle, Wachen), `3d-sicht.jsx` (Handouts, Tischfenster), `3e-welt.jsx` (Figuren, Zeitleiste, lokale Dateien, Quests, Wissen, Fraktionen, Hex), `3f-gruppe.jsx` (Heldengruppen), `4-app.jsx` (die Seite) |
